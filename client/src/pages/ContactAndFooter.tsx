    ...
    <div id="contact" className="bg-transparent text-white pt-24">
      ...
      <footer className="border-t border-white/5 px-6 pt-20 pb-10 bg-black/40 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-16 mb-20">
          ...
          <div><h4 className="font-bold text-xs uppercase mb-8 text-[#FF8C00]">✨ New Features</h4><ul className="text-gray-500 text-sm space-y-4"><li>🚀 Docker Auto-Deploy</li><li>💎 Premium Fleet</li><li>🔒 Secure Booking</li></ul></div>
        </div>
        <div className="max-w-7xl mx-auto pt-10 border-t border-white/5 text-center">
          <p className="text-gray-600 text-[10px] font-bold uppercase tracking-[0.4em]">© 2025 VoltDrive. All Rights Reserved. | 🐳 Running in Docker Containers</p>
        </div>
      </footer>
    </div>
  );
